...
final class RouteView: BaseUIView {
    ...
    private let addRouteButton = UIButton(type: .system)
    ...
    override func setUI() {
        addSubviews(myRouteLabel, countRouteLabel, toggleButton, routeStackView, addRouteButton)
    }
    ...
    private func configureHeader(pointCount: Int) {
        ...
        case .read:
            ...
            toggleButton.isHidden = pointCount > collapsedPointCount ? false : true
...
private final class RoutePointRowView: BaseUIView {
